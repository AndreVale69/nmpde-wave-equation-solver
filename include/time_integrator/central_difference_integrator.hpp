#ifndef NM4PDE_CENTRAL_DIFFERENCE_INTEGRATOR_HPP
#define NM4PDE_CENTRAL_DIFFERENCE_INTEGRATOR_HPP
...
class CentralDifferenceIntegrator : public TimeIntegrator {
public:
...
#endif // NM4PDE_CENTRAL_DIFFERENCE_INTEGRATOR_HPP
